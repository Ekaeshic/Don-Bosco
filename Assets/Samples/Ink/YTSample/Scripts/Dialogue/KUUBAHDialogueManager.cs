...
namespace InkDialogue
{
    /// NOTE: Script ini sudah dimodifikasi untuk kemudahan dalam penggunaan
    public class KUUBAHDialogueManager : MonoBehaviour
    {
        [Header("Params")]
        ...
        private static KUUBAHDialogueManager instance;
        ...
        public static KUUBAHDialogueManager GetInstance() 
        {
            return instance;
        }
